                ...
                <tr>
                    <td style="height: 20px; background-color: #8CA1AE;">
                        <table width="157" style="height: 100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="background-image: url(../../images/bg.gif);">申请物品归还</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="12%">
                                            <asp:DropDownList ID="query_tj" runat="server" Width="98%">
                                                <asp:ListItem Value="thbt" Selected="True">归还标题</asp:ListItem>
                                                <asp:ListItem Value="thsm">归还说明</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td width="10%">
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                                                   ...
                                                   DataKeyNames=   "ghid"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="ghid" HeaderText="归还id号">
                                                        ...
                                                        <asp:BoundField DataField="fl_mc" HeaderText="物品分类">
                                                            <HeaderStyle ForeColor="black" />
                                                            <ItemStyle HorizontalAlign="center" />
                                                        </asp:BoundField>
