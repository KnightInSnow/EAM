...
<body class="main">
    <form id="form1" runat="server">
        ...
        <div class="PageHead">
             <div style="margin-top:57px;color:#70708f;">归还确认</div>
        </div>
        <div class="PageBody">
            <div class="PageBody-Top">
                <div class="PageBody-Top-Inputs" style="height:130px;">
                    <table style="table-layout: fixed">
                        <tr>
                            <td style="text-align:right;padding-right:10px;">归还单号：</td>
                            <td>
                            ...
                            <td style="text-align:right;padding-right:10px;">归还单状态：</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td style="text-align:right;padding-right:10px;">申请人：</td>
                            <td>
                ...
                <div class="PageBody-Top-Buttons" style="margin-top:10px;">
                    <table style="table-layout:fixed;">
                        <tr>
                            <td align="left" colspan="1" style="visibility: hidden"><font color="red">只显示您负责管理的仓库下的入库登记信息！</font></td>

                            <td align="right">
                                <asp:Button ID="QueryBtn" runat="server" AccessKey="f" CausesValidation="true" CssClass="btn btn-primary active" OnClick="QueryBtn_Click" Text="查询" />
                                <asp:Button ID="ClearBtn" runat="server" AccessKey="r" CausesValidation="false" CssClass="btn btn-primary active" OnClick="Clear_Click" Text="清空" UseSubmitBehavior="False" />
                                <asp:Button ID="RefBtn" runat="server" AccessKey="e" CausesValidation="false" CssClass="btn btn-primary active" OnClick="Ref_Click" Text="刷新" UseSubmitBehavior="False" />
                            </td>
                    </table>
                </div>
            </div>
                ...
                <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                    <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ghid" HeaderText="归还单ID">
                            ...
                            <asp:BoundField DataField="ghbt" HeaderText="归还标题">
                                <HeaderStyle ForeColor="black" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="ghsm" HeaderText="备注">
                                <HeaderStyle ForeColor="black" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="ghdh" HeaderText="归还单号">
                                <HeaderStyle CssClass="hidden" />
                                <ItemStyle CssClass="hidden" />
                                <FooterStyle CssClass="hidden" />
                                <ItemStyle HorizontalAlign="Center" />
