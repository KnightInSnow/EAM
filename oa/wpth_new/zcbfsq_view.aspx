<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zcbfsq_view.aspx.cs" Inherits="FCSystem.OA.wpth_new.zcbfsq_view" %>
                ...
                <tr>
                    <td style="height: 20px; background-color: #8CA1AE;">
                        <table width="157" style="height: 100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="background-image: url(../../images/bg.gif);">申请资产报废</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                            ...
                            <table style="table-layout:fixed;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td widht="8%">状态：</td>
                                        <td width="12%">
                                            <asp:DropDownList ID="bfzt" runat="server" Width="98%">
                                        ...
                                        <td width="30%" align="right">
                                            <asp:Button cssclass="mybutton" ID="QueryBtn" runat="server" Text="查询" OnClick="Query_Click" CausesValidation="False" AccessKey="f" /><input type="button" name="AddBtn" value="资产报废申请" class="qq_btn_100px" onclick="javascript: window.open('zcbfsq.aspx', null, 'width=900, height=650,top=' + (screen.height - 700) / 2 + ',left=' + (screen.width - 850) / 2 + ', scrollbars=yes,resizable=yes')"; accesskey="a" /><asp:Button CssClass="mybutton" ID="RefBtn" runat="server" Text="刷新" OnClick="Query_Click" CausesValidation="False" AccessKey="e" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                                   ...
                                                   DataKeyNames=   "bfid"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="报废单号">
                                                            ...
                                                            <ItemStyle HorizontalAlign="center" />
                                                            <ItemTemplate>
                                                               <%-- <a href="#" onclick="javascript:popMod('/oa/wpth_new/zcbfsq_modnew.aspx?id=<%# Eval("bfid") %>')">--%>
