<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rkcx.aspx.cs" Inherits="FCSystem.OA.wprk.rkcx" %>
...
<body class="main" accesskey="QueryBtn">
    ...
    <form id="form1" runat="server">
        ...
        <div class="PageHead">
            <div style="margin-top:57px;color:#70708f;">入库清单查询</div>
        </div>
            ...
            <div class="PageBody-Top">
                <div class="PageBody-Top-Inputs" style="height:130px;">
                    <table style="table-layout: fixed">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="rkck" runat="server" OnSelectedIndexChanged="rkck_SelectedIndexChanged" AutoPostBack="True" CssClass="form-control">
                        ...
                        <tr>
                            <td style="text-align:right;padding-right:10px;">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="*"
                                    ControlToValidate="txtbegintime" ValidationExpression="(?!0000)[0-9]{4}-((0[1-9]|1[0-2])-(0[1-9]|1[0-9]|2[0-8])|(0[13-9]|1[0-2])-(29|30)|(0[13578]|1[02])-31)">&nbsp</asp:RegularExpressionValidator>录入时间(自)：</td>
                            <td>
                            ...
                            <td style="text-align:right;padding-right:10px;">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="*"
                                    ControlToValidate="txtendtime" ValidationExpression="(?!0000)[0-9]{4}-((0[1-9]|1[0-2])-(0[1-9]|1[0-9]|2[0-8])|(0[13-9]|1[0-2])-(29|30)|(0[13578]|1[02])-31)">&nbsp</asp:RegularExpressionValidator>录入时间(至)：</td>
                            <td>
                ...
                <div class="PageBody-Top-Buttons" style="margin-top:10px;">
                    <table style="table-layout: fixed;">
                        <tr>
                            <td align="right">
                                <asp:Button CssClass="btn btn-primary active" ID="DelBtn" runat="server" AccessKey="d" Text="删除" OnClick="DelBtn_Click" Visible="true" UseSubmitBehavior="False" />
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:CheckBox ID="SelectEvery" runat="server" CssClass="mybox" AutoPostBack="False" />
                            </ItemTemplate>
                        </asp:TemplateField>
