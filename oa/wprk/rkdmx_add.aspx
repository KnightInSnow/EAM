<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="rkdmx_add.aspx.cs" Inherits="FCSystem.OA.wprk.rkdmx_add" %>
...
<body class="main">
    <form id="form1" runat="server">
        <table>
            <tbody>
                <tr>
                    <td class="td_oa" style="width: 80%; height: 25px">登记入库物品明细</td>
                                        ...
                                        <table style="table-layout: fixed;">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" style="height: 30px">
                                                    <asp:Button cssclass="mybutton" ID="SaveAddBtn" runat="server" Text="保存并新建" OnClick="Save_Click" AccessKey="a"></asp:Button><asp:Button CssClass="mybutton" ID="SaveBtn" runat="server" Text="保存" OnClick="Save_Click" AccessKey="s"></asp:Button><asp:Button ID="Button2" Text="清空" OnClick="Clear_Click" runat="Server" CausesValidation="false" CssClass="mybutton" AccessKey="r" /></asp:Button><input type="button" name="BackBtn" value="关闭" class="mybutton" onclick="javascript: window.close()" accesskey="q" />&nbsp;
