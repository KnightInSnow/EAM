                                ...
                                <tbody>
                                    <tr width="100%">
                                        ...
                                        <td width="15%" align="right">
                                            <asp:Button ID="btn_refresh" runat="server" Text="刷新" cssclass="mybutton" OnClick="btn_refresh_Click"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                                            <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="使用人确认">
                                                        <HeaderStyle Width="120px" />
                                                        <ItemStyle Width="126px" Height="16px" />
                                                        <ItemTemplate>
                                                            <asp:Button ID="btn_syr" runat="server" Width="50%" Text="同意" CommandArgument='<%# Eval("syrqr")%>' CommandName='<%# Eval("pdqdtid")%>' OnClick="btn_syr_Click" /><asp:Button ID="btn_syryj" runat="server" Text="不同意" CommandArgument='<%# Eval("pdqdtid") %>' OnClick="btn_syryj_Click"/>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:TemplateField>
