<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="plansetting.aspx.cs" Inherits="FCSystem.OA.pd.plansetting" %>
...
<body class="main">
    <form id="form1" runat="server">
        <div class="PageHead">
            <div style="margin-top:57px;color:#70708f;">计划设定</div>
        </div>
        <div class="PageBody">
            <div class="PageBody-Top">
                ...
                <div class="PageBody-Top-Buttons">
                    <table style="table-layout: fixed;">
                        <tr>
                            <td align="right">
                                <asp:Button ID="btn_query" runat="server" Text="查询" CssClass="btn btn-primary active" OnClick="btn_query_Click" />
                                <asp:Button ID="btn_add" runat="server" Text="添加计划" CssClass="btn btn-primary active" />
                                <asp:Button ID="btn_del" runat="server" Text="删除计划" CssClass="btn btn-primary active" OnClick="btn_del_Click" />
            ...
            <div class="PageBody-Middle-MinHeight">
                <tr>
                    <td align="left"><font color="red">点击计划名称可查看盘点清单</font></td>
                </tr>
                <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                    <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="pddh" HeaderText="盘点计划单号">
                            ...
                            <asp:TemplateField HeaderStyle-ForeColor="Black" HeaderText="计划名称">
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <a href="#" onclick="javascript:popPlan('planList.aspx?id=<%#Eval("planid")%>')"><font color="#3366ff"><asp:Label ID="lbljhmc" runat="server" Text='<%#Bind("planname") %>'></asp:Label></font></a>
                                </ItemTemplate>
                            ...
                            <asp:BoundField DataField="yn_download" HeaderText="手机执行" Visible="True">
                                <HeaderStyle ForeColor="Black" />
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
