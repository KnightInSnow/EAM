<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_assetz_xxpande.aspx.cs" Inherits="FCSystem.OA.report_table.report_assetz_xxpande" %>
...
<body>
    <form id="form1" runat="server">
                                ...
                                <td>                                 
                                    <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ry" HeaderText="领用/报废人">
                                                <HeaderStyle ForeColor="black" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="bm" HeaderText="领用/报废部门">
                                                <HeaderStyle ForeColor="black" />
                                            </asp:BoundField>
        ...
        <asp:Label ID="lybm" runat="server" Visible="False"></asp:Label>
        <asp:Label ID="wpmc" runat="server" Text="" Visible="false"></asp:Label>
        <asp:Label ID="username" runat="server" Visible="False"></asp:Label>
        <asp:Label ID="zczk" runat="server" Text="" Visible="false"></asp:Label>
        <asp:Label ID="ssfl" runat="server" Text="" Visible="false"></asp:Label>
    </form>
</body>
</html>
