<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_assetz_xx.aspx.cs" Inherits="FCSystem.OA.report_table.report_assetz_xx" %>
...
<head id="Head1" runat="server">
    ...
    <title>资产总账（信息）报表</title>
</head>
<body>
    <form id="form1" runat="server">
        <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="True">
        </asp:ScriptManager>
        <div class="PageHead">资产总账（信息）</div>
                ...
                <div class="PageBody-Top-Inputs">
                    <table style="table-layout: fixed">
                        ...
                        <tr>
                            ...
                            <td>物资状况：</td>
                            <td>
                                <asp:DropDownList ID="zczk" runat="server">
                                    <asp:ListItem Text="" Value=""></asp:ListItem>
                                    <asp:ListItem Text="在库" Value="在库"></asp:ListItem>
                                    <asp:ListItem Text="使用中" Value="使用中"></asp:ListItem>
