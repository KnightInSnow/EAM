                ...
                <tr>
                    <td style="height: 20px; background-color: #8CA1AE;">
                        <table width="157" style="height: 100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="background-image: url(../../images/bg.gif);">在修设备查询</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                ...
                                <tbody>
                                    <tr width="100%">
                                        ...
                                        <td width="30%" align="right">
                                            <asp:Button ID="btnQuery" runat="server" AccessKey="f" CausesValidation="False" cssclass="mybutton" Text="查询" OnClick="btnSave_Click" /><asp:Button ID="btnClear" runat="server" AccessKey="f" CausesValidation="False" cssclass="mybutton" Text="清空" OnClick="btnClear_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                                            <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="wxdkssj" HeaderText="送修时间" DataFormatString="{0:yyyy-MM-dd}">
                                                        <HeaderStyle ForeColor="Black" />
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="gysmc" HeaderText="维修单位">
                                                        <HeaderStyle ForeColor="Black" />
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="tjry" HeaderText="操作人员">
                                                        <HeaderStyle ForeColor="Black" />
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
