<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bftjcx.aspx.cs" Inherits="FCSystem.OA.wpcx.bftjcx" %>
                ...
                <tr>
                    <td style="height: 20px; background-color: #8CA1AE;">
                        <table width="157" style="height: 100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="background-image: url(../../images/bg.gif);">报废统计查询</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                                                   ...
                                                   DataKeyNames=   "ck_tid"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="bfwpsl" HeaderText="报废数量">
