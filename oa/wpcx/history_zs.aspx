<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="history_zs.aspx.cs" Inherits="FCSystem.OA.wpcx.history_zs" %>
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="申请人">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <a href="#" onclick="javascript:popAdd2('/oa/wply/sqrzcAll.aspx?id=<%#Eval("his_actionrenid") %>')"><font color="#3366ff"><asp:Label ID="lblsqr" runat="server" text='<%#Bind("his_actionren") %>'>'></asp:Label></font></a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
