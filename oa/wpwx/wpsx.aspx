<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wpsx.aspx.cs" Inherits="FCSystem.OA.wpwx.wpsx" %>
                ...
                <tr>
                    <td style="height: 20px; background-color: #8CA1AE;">
                        <table width="157" style="height: 100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="background-image: url(../../images/bg.gif);">保外送修确认</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                    ...
                                    <tr width="100%">
                                        ...
                                        <td width="15%" class="">
                                          <asp:DropDownList ID="zt" runat="server" Width="100%">
                                              ...
                                              <asp:ListItem Value="3" Text="维修单结单"></asp:ListItem>
                                              <asp:ListItem Value="4" Text="维修中"></asp:ListItem>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-ForeColor="Black" HeaderText="维修名称">
                                                        ...
                                                        <ItemTemplate>
                                                             ...
                                                             <a href="#" onclick="javascript:popAdd2('wpsx_mx.aspx?id=<%#Eval("wxd_id")%>&id2=<%#Eval("wxzt")%>')"><font color="#3366ff"><asp:Label ID="lbljhmc" runat="server" Text='<%#Bind("wxd_name") %>'></asp:Label></font></a>
                                                        </ItemTemplate>
