<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wxzcqr.aspx.cs" Inherits="FCSystem.OA.wpwx.wxzcqr" %>
                ...
                <tr>
                    <td style="height: 20px; background-color: #8CA1AE;">
                        <table width="157" style="height: 100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="background-image: url(../../images/bg.gif);">资产维修确认</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-ForeColor="Black" HeaderText="维修单名称">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <a href="#" onclick="javascript:openwin_new('wxqr_mod.aspx?id=<%#Eval("wxd_id")%>')"><font color="#3366ff"><asp:Label ID="lbljhmc" runat="server" Text='<%#Bind("wxd_name") %>'></asp:Label></font></a>
                                                        </ItemTemplate>
                                                    ...
                                                    <%--                                                    <asp:TemplateField HeaderText="询价维修">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <a href="#" onclick="javascript:popMod('xjwx.aspx?id=<%#Eval("wxd_id")%>')"><font color="#3366ff">询价维修</font></a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>--%>
