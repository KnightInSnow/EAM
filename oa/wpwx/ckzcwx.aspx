<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ckzcwx.aspx.cs" Inherits="FCSystem.OA.wpwx.ckzcwx" %>
                                ...
                                <tbody>
                                    <tr width="100%">
                                        ...
                                        <td width="33%" align="right">
                                            <asp:Button ID="btn_add" runat="server" Text="新增维修申请" cssclass="mybutton" /><asp:Button ID="btn_del" runat="server" Text="删除" cssclass="mybutton" Visible="false" OnClick="btn_del_Click" /><asp:Button ID="btn_Refresh" runat="server" Text="刷新" cssclass="mybutton" OnClick="btn_Refresh_Click" /><asp:Button ID="btnClear" runat="server" AccessKey="f" CausesValidation="False" cssclass="mybutton" Text="清空" OnClick="btnClear_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                                            <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="wxd_dh" HeaderText="维修单单号">
