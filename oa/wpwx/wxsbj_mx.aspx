        ...
        <table style="table-layout: fixed">
            <tbody>
                ...
                <tr>
                                        ...
                                        <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                                            <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="维修金额">
                                                        <HeaderStyle ForeColor="black" Width="30%" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txt_wxje" runat="server" Width="90%" align="center" ToolTip="请输入正整数"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                    ...
                    <td >                                              
                        <asp:Label ID="cxsmlb" Text="维修单总说明：" runat="server"></asp:Label>
                        </td>
                            ...
                            <tr>
                                 ...
                                 <td width="10%">
                                        ...
                                        <td width="28%" align="right">
                                            <asp:Button ID="btnSave" runat="server" AccessKey="f" CausesValidation="False" cssclass="mybutton" Text="维修报价" OnClick="btnSave_Click" /> <asp:Button ID="btnfinish" runat="server" AccessKey="f" CausesValidation="False" cssclass="mybutton" Text="维修完成" OnClick="btnfinish_Click" /><asp:Button ID="btngriveup" runat="server" AccessKey="f" CausesValidation="False" cssclass="mybutton" Text="放弃报价" OnClick="btngriveup_Click" Visible="false" />
                                        </td>
