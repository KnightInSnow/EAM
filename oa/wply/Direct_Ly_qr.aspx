...
<body class="main">
    <form id="form1" runat="server">
        ...
        <div class="PageHead">
            <div style="margin-top:57px;color:#70708f;">领用确认</div>
        </div>
        <div class="PageBody">
            <div class="PageBody-Top">
                <div class="PageBody-Top-Inputs">
                    <table style="table-layout: fixed">
                        <tr>
                            <td style="text-align:right;padding-right:10px;">领用单号：</td>
                            <td>
                                <asp:TextBox ID="lydh" runat="server" MaxLength="10" CssClass="form-control"></asp:TextBox>
                            </td>


                            <td style="text-align:right;padding-right:10px;">发放仓库：</td>
                            <td>
                            ...
                            <td style="text-align:right;padding-right:10px;"> 领用单状态：</td>
                            <td>
