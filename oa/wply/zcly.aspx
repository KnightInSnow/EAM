<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="zcly.aspx.cs" Inherits="FCSystem.OA.wply.zcly" %>
...
<body class="main">
    <form id="form1" runat="server">
        <input type="hidden" name="AddBtn" value="物品交接" class="qq_btn_100px" onclick="    javascript: popAdd2('wdwp_jjview.aspx');" accesskey="a" />
                ...
                <tr>
                    <td style="height: 20px; background-color: #8CA1AE;">
                        <table width="157" style="height: 100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="background-image: url(../../images/bg.gif);">资产出库登记</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                ...
                                <tbody>
                                    <tr width="100%">
                                        ...
                                        <td align="right" width="25%">
                                            <asp:Button ID="QueryBtn" runat="server" AccessKey="f" CausesValidation="False" cssclass="mybutton" OnClick="Query_Click" Text="查询" /><input type="button" name="AddBtn1" value="领用新资产" class="qq_btn_100px" onclick="javascript: popAdd2('zcly_addnew.aspx');" accesskey="a" /><asp:Button ID="RefBtn" runat="server" AccessKey="e" CausesValidation="False" cssclass="mybutton" OnClick="Query_Click" Text="刷新" />
                                        </td>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="领用单编号">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <a href="#" onclick="javascript:popAdd2('/oa/wply/zcly_modnew.aspx?id=<%# Eval("lyid") %>')">
