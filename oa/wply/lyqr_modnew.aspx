<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="lyqr_modnew.aspx.cs" Inherits="FCSystem.OA.wply.lyqr_modnew" %>
...
<body class="main" onload="loadpage();">
    ...
    <script type="text/javascript">
        ...
        function ScanUpload() {
            ...
            i = print.DPK("C:\\fc_lydj_temp\\", filename, "", 33, 2, 0, 200, "EAM-seefefedfeeg4oouiouujhjuu345]hhu", "");
    ...
    <form id="form1" runat="server">
        <table>
            <tbody>
                <tr>
                    <td>
                        <asp:Button cssclass="mybutton" ID="SpBtn" runat="server" Text="审批通过" OnClick="Sp_Click" Visible="false" /><asp:Button cssclass="mybutton" ID="ThBtn" runat="server" Text="审批退回" OnClick="Th_Click" Visible="false" /><input type="button" name="BackBtn" value="关闭" class="qq_btn_100px" onclick="javascript: window.close()" accesskey="q" /><asp:Button ID="btnNext" runat="server" Visible="false" Text="审批下一单" cssclass="mybutton" OnClick="btnNext_Click" />
                    </td>
                    ...
                    <table style="table-layout:fixed;">
				        ...
				        <tr>
                         ...
                         <tr>
                            ...
                            <td><asp:TextBox ID="tbxBz" runat="server" Width="500px" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
         ...
         <asp:GridView ID="GridView1" runat="server" CssClass="GridViewStyle"
                                ...
                                <Columns>                        
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>资产编码</HeaderTemplate>
                                         <ItemStyle HorizontalAlign="Center" />
                                         <ItemTemplate>
                                             <asp:TextBox ID="tbx_zcbm" runat="server" Text='<%#Bind("zcbmfull")%>'></asp:TextBox><asp:Button ID="btn_update" runat="server" Text="刷新" OnClick="btn_update_Click" CommandArgument='<%# Container.DataItemIndex %>'></asp:Button>
                                         </ItemTemplate>
                                    </asp:TemplateField>
        ...
        <%--    <asp:RequiredFieldValidator
            ...
            ErrorMessage="请填写审批意见">&nbsp; </asp:RequiredFieldValidator>--%>
