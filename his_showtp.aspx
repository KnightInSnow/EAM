<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="his_showtp.aspx.cs" Inherits="FCSystem.his_showtp" %>
...
<body onload="loadPic();">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="jjdh" runat="server"  Visible="False"></asp:Label>
        <asp:Label ID="bfdh" runat="server" Visible="False"></asp:Label>
        <asp:Label ID="pdjhid" runat="server"  Visible="False"></asp:Label>
        <asp:Label ID="wxdid" runat="server" Visible="False"></asp:Label>
        <asp:Label ID="zcbmfull" runat="server"  Visible="False"></asp:Label>
        <asp:Label ID="tpsx" runat="server" Visible="False"></asp:Label>
